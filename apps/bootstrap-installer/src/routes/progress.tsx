...
export default function ProgressScreen({ bootstrap }: ProgressProps) {
  ...
  const title = bootstrap.status === 'completed' ? 'Done' : isUpdate ? 'Updating Douglas Agent' : 'Setting up Douglas Agent'

  const description = isUpdate
    ? 'Douglas Agent is updating to the latest version — this only takes a moment.'
    : 'This is a one-time setup. The Douglas installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.'
