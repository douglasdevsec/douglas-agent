 ...
 *
 * A public install can end up with `origin=git@github.com:douglasdevsec/douglas-agent.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/douglasdevsec/douglas-agent.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/douglasdevsec/douglas-agent'
