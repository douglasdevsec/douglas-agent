...
def _update_via_zip(args):
    ...
    if branch != "main":
        ...
        _m().sys.exit(1)
    zip_url = (
        f"https://github.com/douglasdevsec/douglas-agent/archive/refs/heads/{branch}.zip"
    )
    ...
    try:
        ...
        # GitHub ZIPs extract to douglas-agent-<branch>/
        extracted = os.path.join(tmp_dir, f"douglas-agent-{branch}")
